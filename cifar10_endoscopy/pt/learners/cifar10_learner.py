...
class CIFAR10Learner(Learner):  # also supports CIFAR10ScaffoldLearner
    def __init__(
        self,
        train_idx_root: str = "/home/deepak/fed/dataset",
        ...
        self.TRAIN_DATA_PATH = "/home/deepak/fed/dataset/train2/"
        self.TEST_DATA_PATH = "/home/deepak/fed/dataset/val/"
    ...
    def _create_datasets(self, fl_ctx: FLContext):
        ...
        self.train_loader = data.DataLoader(self.train_dataset, batch_size=32, shuffle=True,  num_workers=0)
        
        self.valid_dataset = torchvision.datasets.ImageFolder(root=self.TEST_DATA_PATH, transform=self.transform_valid)
        self.valid_loader = data.DataLoader(self.valid_dataset, batch_size=32, shuffle=True,  num_workers=0)
    ...
    def local_train(self, fl_ctx, train_loader, model_global, abort_signal: Signal, val_freq: int = 0):
        for epoch in range(self.aggregation_epochs):
            ...
            for i, (inputs, labels) in enumerate(train_loader):
                ...
                b_y = F.one_hot(labels), num_classes=2)
