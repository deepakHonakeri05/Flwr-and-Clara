...
def train(model, train_loader, epochs):
    ...
    for epoch in range(epochs):
        ...
        writer.add_scalar("train_loss",avg_train_loss/len(train_loader),epoch)
...
def test(model, valid_loader):
    ...
    with torch.no_grad():
        ...
        avg_val_acc = metric/len(valid_loader)
        writer.add_scalar("val_acc_local_model",avg_val_acc,i)
