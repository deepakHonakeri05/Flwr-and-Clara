...
from pt.networks.endoscopy_nets import ClassificationModel
from pt.utils.endoscopy_dataset import EndoscopyDataset
from pt.utils.endoscopy_data_splitter import ENDOSCOPY_SPLITS_DESTINATION, ENDOSCOPY_VALID_DESTINATION

from pt.utils.endoscopy_data_splitter import EndoscopyDataSplitter
...
class ENDOSCOPYLearner(Learner):
    def __init__(
        self,
        train_idx_root: str = ENDOSCOPY_SPLITS_DESTINATION,
        ...
        """Simple ENDOSCOPY Trainer.

        Args:
            train_idx_root: directory with site training indices for ENDOSCOPY data.
        ...
        self.valid_idx_root = ENDOSCOPY_VALID_DESTINATION
