...
def main():
    ...
    parser.add_argument("--job", type=str, default="endoscopy_fedavg", help="Path to job config.")
    ...
    parser.add_argument("--train_split_root", type=str, default="/tmp/endoscopy_splits", help="Location where to save data splits.")
    ...
    if args.alpha > 0.:
        ...
        split_dir = args.train_split_root
